import { shallowRef as Tt, unref as F, shallowReactive as Vt, nextTick as xt, defineComponent as le, reactive as It, inject as K, computed as x, h as ct, provide as ve, ref as Se, watch as Te, getCurrentInstance as lt, watchEffect as Dt, onMounted as Mt, openBlock as M, createElementBlock as j, createElementVNode as q, toDisplayString as ye, Fragment as we, renderList as Ue, resolveComponent as Qe, createVNode as Ge, withKeys as jt, pushScopeId as Lt, popScopeId as qt } from "vue";
function Bt() {
...
function Ht() {
  var e;
  return W !== void 0 || (typeof window < "u" && window.performance ? (W = !0, Re = window.performance) : typeof globalThis < "u" && (!((e = globalThis.perf_hooks) === null || e === void 0) && e.performance) ? (W = !0, Re = globalThis.perf_hooks.performance) : W = !1), W;
}
function Kt() {
  return Ht() ? Re.now() : Date.now();
}
class zt {
  constructor(t, n) {
...
function sn(e) {
  return Ve(e).replace(pt, "{").replace(gt, "}").replace(ht, "^");
}
function Pe(e) {
  return Ve(e).replace(dt, "%2B").replace(rn, "+").replace(ft, "%23").replace(Yt, "%26").replace(nn, "`").replace(pt, "{").replace(gt, "}").replace(ht, "^");
}
function an(e) {
  return Pe(e).replace(Xt, "%3D");
}
function cn(e) {
  return Ve(e).replace(ft, "%23").replace(Zt, "%3F");
}
function ln(e) {
...
function nt(e) {
  ...
  for (let n in e) {
    ...
    (V(o) ? o.map((f) => f && Pe(f)) : [o && Pe(o)]).forEach((f) => {
...
const zn = Symbol(process.env.NODE_ENV !== "production" ? "router view location matched" : ""), ot = Symbol(process.env.NODE_ENV !== "production" ? "router view depth" : ""), xe = Symbol(process.env.NODE_ENV !== "production" ? "router" : ""), Et = Symbol(process.env.NODE_ENV !== "production" ? "route location" : ""), Ce = Symbol(process.env.NODE_ENV !== "production" ? "router view location" : "");
function ee() {
  let e = [];
  function t(o) {
    return e.push(o), () => {
...
const Yn = /* @__PURE__ */ le({
  ...
  useLink: rt,
  setup(e, { slots: t }) {
    const n = It(rt(e)), { options: o } = K(xe), s = x(() => ({
...
const at = (e, t, n) => e ?? t ?? n, eo = /* @__PURE__ */ le({
  ...
  setup(e, { attrs: t, slots: n }) {
    ...
    const o = K(Ce), s = x(() => e.route || o.value), f = K(ot, 0), u = x(() => {
      let h = F(f);
    ...
    ve(ot, x(() => u.value + 1)), ve(zn, d), ve(Ce, s);
    const l = Se();
    return Te(() => [l.value, d.value, e.name], ([h, r, c], [i, p, y]) => {
      ...
      if (process.env.NODE_ENV !== "production" && L && N.ref) {
        const _ = {
          depth: u.value,
          name: c.name,
          path: c.path,
...
${JSON.stringify(v, null, 2)}
 when navigating to "${a.fullPath}". A redirect must contain a name or path. This will break in production.`), new Error("Invalid redirect");
  ...
  function X(a, m) {
    ...
    return !$ && Ke(o, v, g) && (H = J(16, { to: O, from: v }), qe(
      ...
      !1
    )), (H ? Promise.resolve(H) : De(O, v)).catch((A) => D(A) ? (
 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`), Promise.reject(new Error("Infinite redirect in navigation guard"))) : X(
  ...
  function je(a, m, g, v, R) {
    const $ = C(a, m);
    if ($)
      return $;
    const w = m === B, b = L ? history.state : {};
  ...
  function $t() {
    Z || (Z = s.listen((a, m, g) => {
      ...
      h = v;
      const $ = l.value;
      L && En(We($.fullPath, g.delta), ue()), De(v, $).catch((w) => D(
        w,
        12
        /* ErrorTypes.NAVIGATION_CANCELLED */
      ) ? w : D(
  ...
  function At() {
    return se && l.value !== B ? Promise.resolve() : new Promise((a, m) => {
      de.add([a, m]);
    });
  }
  function pe(a) {
  ...
  const ae = /* @__PURE__ */ new Set(), Be = {
    ...
    install(a) {
      ...
      !me && l.value === B && (me = !0, T(s.location).catch((R) => {
      ...
      a.provide(xe, m), a.provide(Et, Vt(g)), a.provide(Ce, l);
      const v = a.unmount;
      ae.add(a), a.unmount = function() {
        ae.delete(a), ae.size < 1 && (h = B, Z && Z(), Z = null, l.value = B, me = !1, se = !1), v();
      }, process.env.NODE_ENV !== "production" && L && ro(a, m, t);
    }
  };
  function z(a) {
...
const vo = [
...
}, Eo = { class: "search-results-container" }, bo = { class: "container-description" }, So = { class: "badgesOfsearchData" }, wo = {
  key: 0,
  class: "results"
}, Ro = ["href"], Po = {
  key: 1,
  ...
  setup(e) {
    const t = Se([{ _id: "", label: "", tags: [""], url: "" }]), n = Ot(), o = Se("");
    Mt(() => {
      n ? (o.value = n.currentRoute.value.params.tag, s(o.value)) : o.value = "undefined";
    });
    const s = async (f) => {
      const u = await _o(f);
      u && (t.value = u);
    };
    return Te(n.currentRoute, (f, u) => {
      const d = f.params.tag || "", l = u.params.tag || "";
      d !== l && s(d);
    }), (f, u) => (M(), j("div", Eo, [
      q("div", bo, [
        q("button", {
        ...
        q("div", So, " (" + ye(t.value.length) + " records in total) ", 1)
      ]),
      t.value.length ? (M(), j("div", wo, [
        q("ul", null, [
          (M(!0), j(we, null, Ue(t.value, (d, l) => (M(), j("li", { key: l }, [
            q("a", {
              href: d.url,
              target: "_blank",
              class: "linkToResource"
            }, ye(d.label), 9, Ro),
            (M(!0), j(we, null, Ue(d.tags, (h, r) => (M(), j("span", {
              key: r,
  ...
  for (const [o, s] of t)
    n[o] = s;
  return n;
}, Ae = /* @__PURE__ */ Ie(No, [["__scopeId", "data-v-4c651413"]]), ko = {}, Oo = { id: "app" };
function Co(e, t) {
...
const $o = /* @__PURE__ */ Ie(ko, [["render", Co]]), Ao = [
  { path: "/", component: $o },
  { path: "/search-in-tag/:tag", component: Ae }
], To = go({
  history: Pn("/"),
  routes: Ao
});
...
const Vo = (e) => (Lt("data-v-adc0d429"), e = e(), qt(), e), xo = { class: "search-container" }, Io = { class: "search-box" }, Do = /* @__PURE__ */ Vo(() => /* @__PURE__ */ q("label", { for: "" }, null, -1)), Mo = /* @__PURE__ */ le({
  __name: "CrucibleSearch",
  setup(e) {
    const t = Ot(), n = (o) => {
      t.push({ path: `/search-in-tag/${o || "2011"}` });
    };
...
}), jo = /* @__PURE__ */ Ie(Mo, [["__scopeId", "data-v-adc0d429"]]);
function qo(e, t) {
  const { router: n, getApi: o } = t;
  e.component("CrucibleSearch", jo), e.component("DisplayResult", Ae), e.provide("$router", n), e.provide("$getApi", o), n.addRoute({ path: "/search-in-tag/:tag", component: Ae });
}
export {
